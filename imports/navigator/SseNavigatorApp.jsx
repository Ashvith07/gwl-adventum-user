...
//old search bar---------
    ...
    render() {
        ...
        let count =this.state.imagesCount
        console.log(count)
                    ...
                    <div className="w100">
                        ...
                        } */}
                        {
                            ...
                            <div className="patientinfo">
                              ...
                              <div className="table-row">
                                <div>Date of birth : dd/mm/yy</div>
                              </div>
                              <div className="table-row">
                                 <div>Date of Scan : dd/mm/yy</div>
                              </div>
                              <div className="table-row">
                                 <div>Device : Top Con</div>
                              </div>
                              <div className="table-row">
                                 <div>Eye : Left/Right</div>
                              </div>
                              <div className="table-row">
                                 <div>Last Labelled : 78</div>
                              </div>
                            </div>
